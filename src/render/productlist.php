...
$productCount = $variables['product_count'][0][0]/$perPage;
?>
<div class="container">
	...
	<main class="main">
		<table class="table-product">
			...
			<?php foreach ($variables['product_list'] as $item){
				?>
				<tr>
					<td>
					...
					<td><a href="/?controller=Product&page=<?php echo $item[0]?>">Подробнее...</a></td>
				</tr>
				<?php
			}?>
		...
		<ul class="pagination">
			<?php for ($i =0;$i<$productCount;$i++) {?>
				<li><a href="/?controller=ProductList&page=<?php echo $i+1; ?>"><?php echo $i+1; ?></a></li>
			<?php } ?>
		</ul>
	</main>
</div>
